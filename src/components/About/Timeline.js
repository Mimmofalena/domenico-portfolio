    ...
    <ul className={classes.timeline}>
      ...
      <li>
        <div className={classes["direction-r"]}>
          ...
          <div className={classes.desc}>
            Continuing learning web development focusing mainly on the front end
            and approaching back end too. Still working as a full time nurse
          </div>
        </div>
      </li>
      ...
      <li>
        <div className={classes["direction-r"]}>
          ...
          <div className={classes.desc}>
            High School G.Marconi in Messina. Main subject where electronics and
            telecommunications. We used pascal, CAD,CISCO certification,
