  ...
  return (
    <>
      ...
      <div className={classes.textContainer}>
        ...
        <ul>
          <br />
          <li>- Javascript fundamentals including data types and variables</li>
          <li>
        ...
        <p>
          ...
          articles, watched youtube videos and completed various challenges
          within the 'freecodecamp' website.
          <br /> I soon started a &nbsp;
        ...
        <strong>NODE</strong> js course by Jonas Schmedtmann. During this course
        I made&nbsp;
        <a
          style={{ textDecoration: "underline" }}
